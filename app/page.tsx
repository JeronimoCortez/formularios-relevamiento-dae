...
const colorMap: Record<string, string> = {
  ...
  indigo:
    "bg-indigo-50 border-indigo-200 hover:border-indigo-400 hover:bg-indigo-100 text-indigo-700",
  violet:
    "bg-violet-50 border-violet-200 hover:border-violet-400 hover:bg-violet-100 text-violet-700",
  emerald:
    "bg-emerald-50 border-emerald-200 hover:border-emerald-400 hover:bg-emerald-100 text-emerald-700",
};
      ...
      <div className="bg-blue-900 text-white py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-200 text-base">
            Operativo Territorial de Responsabilidad Parental,
            <br />
